...
function the_team_custom_posts() { 
	// creating (registering) the custom type 
	register_post_type( 'the_team', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Meet the Team', 'bonestheme' ), /* This is the Title of the Group */
	...
	// register_taxonomy_for_object_type( 'category', 'the_team' );
	/* this adds your post tags to your custom post type */
	// register_taxonomy_fcor_object_type( 'post_tag', 'the_team' );
	
}

	// adding the function to the Wordpress init
	add_action( 'init', 'the_team_custom_posts');
    ...
    register_taxonomy( 'custom_cat', 
    	array('the_team'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
    	array('hierarchical' => true,     /* if this is true, it acts like categories */             
    		'labels' => array(
    			'name' => __( 'Team', 'bonestheme' ), /* name of the custom taxonomy */
    			...
    			'new_item_name' => __( 'New Team', 'bonestheme' ) /* name title for taxonomy */
    		),
    		'show_admin_column' => true, 
    		'show_ui' => true,
    		'query_var' => true,
    		'rewrite' => array( 'slug' => 'in-team' ),
    	)
    );   
